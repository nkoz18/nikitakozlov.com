...
function PenroseLSystem() {
	...
	this.startLength = 2400.0; //460.0
	this.theta = TWO_PI / 10; //36 degrees, try TWO_PI / 6.0, ... // 10.0
	this.reset();
}
...
PenroseLSystem.prototype.render = function() {
	...
	for (let i = 0; i < this.steps; ++i) {
		...
		if (step == 'F') {
			stroke(255, 15); //stroke(255, 60);
			for (let j = 0; j < this.repeats; j++) {
				line(0, 0, 0, -this.drawLength); //line(0, 0, 0, -this.drawLength);
				noFill();
